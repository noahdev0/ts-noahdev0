 ...
 * 2025.05.20 ~ 🎮
 * updated by @noahdev
 * https://github.com/noahdev/ts-noahdev0
 *****************************************************************/
...
const createProject = async (projectName) => {
  ...
  try {
    ...
    await succeedConsole(template, spinner, projectName);
  } catch (error) {
 ...
 */
const succeedConsole = async (template, spinner, destination) => {
...
/**
 * @method failConsole
 * @description When the project fails, the console is displayed.
 */
...
/**
 * @method typescriptExpressStarter
